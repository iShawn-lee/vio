#ifndef BACKEND_IMU_INTEGRATION_H
#define BACKEND_IMU_INTEGRATION_H
...
namespace vio {
	namespace backend {
		...
		public:
			...
			/**
			 * noise converiance V, with initial bias a and bias g
			 * @param ba
			 * @param bg
			 */
			...
			///下面是一些读取和重置的函数，不涉及计算
			/// reset measurements
			/// NOTE ba and bg q\v\p\t will not be reset, only measurements and jacobians will be reset!
			void Reset() {
				sum_dt_ = 0;
